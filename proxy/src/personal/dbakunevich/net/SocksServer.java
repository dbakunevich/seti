...
public class SocksServer {
    ...
    private class ServerProcess implements Runnable {
        ...
        public void run() {
            ...
            try {
                handleClients(port);
                System.out.println("SOCKS server stopped...");
            } catch (IOException e) {
        ...
        protected void handleClients(int port) throws IOException {
            ...
            System.out.println("SOCKS server listening at port: " + listenSocket.getLocalPort());
        ...
        private void handleNextClient(ServerSocket listenSocket) {
            try {
                ...
                System.out.println("Connection from : " + Utils.getSocketInfo(clientSocket));
