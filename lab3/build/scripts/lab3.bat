...
set DEFAULT_JVM_OPTS="--module-path" "%APP_HOME%\lib" "--module" "com.example.lab/com.example.lab3.HelloApplication"
...
@rem Execute lab3
"%JAVA_EXE%" %JAVA_OPTS% %LAB3_OPTS% %DEFAULT_JVM_OPTS% %CMD_LINE_ARGS%
