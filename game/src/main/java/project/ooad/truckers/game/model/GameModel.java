...
import project.ooad.truckers.game.Main;
import project.ooad.truckers.game.model.announcement.AnnouncementReceiver;
import project.ooad.truckers.game.model.announcement.AnnouncementSender;
import project.ooad.truckers.game.model.announcement.IpAddress;
import project.ooad.truckers.game.model.events.EventManager;
import project.ooad.truckers.game.model.exceptions.WrongArgException;
...
import project.ooad.truckers.game.model.SnakesProto.GameState;
import project.ooad.truckers.game.model.SnakesProto.GameState.Snake.SnakeState;
import project.ooad.truckers.game.model.SnakesProto.GameConfig;
import project.ooad.truckers.game.model.SnakesProto.GamePlayers;
import project.ooad.truckers.game.model.SnakesProto.GameMessage;
import project.ooad.truckers.game.model.SnakesProto.NodeRole;
...
public class GameModel {
    ...
    private final Map<IpAddress, AnnouncementMsg> availableGames;

    private final List<GamePlayer> players;
    private final List<Snake> snakes;
    private final List<Coord> food;
...
//        resendServerConfirmationTimerTask.schedule(new ResendServerConfirmationTimerTask(), 5000, 5000);
    ...
    private void createClientServer() throws IOException {
        clientServer = new ClientServer(pingDelayMs);
...
//        resendClientServerConfirmationTimerTask.schedule(new ResendClientServerConfirmationTimerTask(), 5000, 5000);
    ...
    private void endServer() {
        netEvents.unsubscribe((EventListener) server, "receivedPacket");
    ...
    public void endGame() {
        ...
        netEvents.unsubscribe((EventListener) clientServer, "receivedPacket");
    }
                    ...
                    if (changeServer) {
                        ...
                        for (GamePlayer player : players) {
                            if (player.getRole() == NodeRole.DEPUTY) {
                                ...
                                sendMessage(InetAddress.getByName(player.getIpAddress()), player.getPort(), createChangeRole2Msg(NodeRole.MASTER, NodeRole.DEPUTY));
