...
public class NewGameController implements Initializable{
    ...
    private final Image movedStartButton = new Image("project.ooad.truckers.game/buttons/start_button/start_2.png");
    private final Image exitedStartButton = new Image("project.ooad.truckers.game/buttons/start_button/start_1.png");
